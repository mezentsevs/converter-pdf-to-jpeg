<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 316 316" {{ $attributes }}>
    ...
    <path stroke="currentColor" stroke-width="10" fill="currentColor" opacity="undefined" d="M158 174.5c-9.116 0-16.5-7.384-16.5-16.5s7.384-16.5 16.5-16.5 16.5 7.384 16.5 16.5-7.384 16.5-16.5 16.5z" />
